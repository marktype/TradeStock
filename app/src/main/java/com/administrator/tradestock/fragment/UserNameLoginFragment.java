 ...
 * Use the {@link UserNameLoginFragment#newInstance} factory method to
...
public class UserNameLoginFragment extends Fragment implements View.OnClickListener{
    ...
    public static UserNameLoginFragment newInstance(String param1, String param2) {
        UserNameLoginFragment fragment = new UserNameLoginFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mView == null){
            mView = inflater.inflate(R.layout.fragment_user_name_login, container, false);
            initWidget();
        }
        return mView;
    }
